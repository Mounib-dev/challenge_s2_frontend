    ...
    <v-dialog v-model="dialogVisible" max-width="600">
      <v-card>
        ...
        <v-card-text>
          ...
          <div v-if="selectedTeam.members.length">
          ...
          <div v-else>
            <div><strong>No members yet! click the edit button to construct the team</strong></div>
          </div>
        </v-card-text>
        <v-card-actions>
          <v-btn link :to="'/edit-team/' + selectedTeam?._id" class="v-btn v-btn--secondary"
            >Edit team</v-btn
          >
